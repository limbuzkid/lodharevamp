 ...
 *
 * @Block(
 *   id = "b-aspi-projects-amenities",
 *   admin_label = @Translation("ASPI Project Amenities"),
 * )
 */

class BCustomASPIProjectsAmenities extends BlockBase {
    /**
     * {@inheritdoc}
     */
...
//
        ...
        return [
            ...
            '#data_obj' => array(array('content'=>'Feature 1')),
        ];
    }
}
