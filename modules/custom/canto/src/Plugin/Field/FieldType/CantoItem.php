...
namespace Drupal\canto\Plugin\Field\FieldType;
 ...
 * @FieldType(
 *   id = "canto_media",
 *   label = @Translation("Canto Media"),
 *   description = @Translation("Canto DAM Integration"),
 *   category = @Translation("Custom"),
 *   default_widget = "CantoWidget",
 *   default_formatter = "CantoFormatter"
 * )
 */
class CantoItem extends FieldItemBase {
