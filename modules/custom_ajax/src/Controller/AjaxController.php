  ...
  class AjaxController extends ControllerBase {
	...
	public function get_calci_result() {
		...
		if(!empty($nids)) {
			...
			$query = \Drupal::database()->insert('prt_calculator_results');
