...
var propName = $('body').find('#location_name').val();
var propLocation = $('body').find('#location_add').val();
...
var propType = $('body').find('#location_type').val();
var propLat = $('body').find('#location_lat').val();
var propLong = $('body').find('#location_lon').val();;
